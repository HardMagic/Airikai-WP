...
<div id="<?php echo $post->ID ?>" style="margin: 7px 0px;" class="article_box illustration isotope-item <?php echo esc_attr(get_post_time('U', true, $post->ID)); echo $pass_class; ?>">
	<div class="article">
		...
		<?php endif ?>
		<a href="<?php echo get_post_meta( $post->ID, 'themov_course_id_new_field', true ); ?>" class="button"><span class="but-r"><span><i class="detail"></i><?php _e( 'Curriculum', LANGUAGE_ZONE) ?></span></span></a>       
