...
?>
<div id="<?php echo $post->ID ?>" style="margin: 11px 0px;" class="article_box illustration isotope-item <?php echo esc_attr(get_post_time('U', true, $post->ID)); echo $pass_class; ?>">
	<div class="article">
